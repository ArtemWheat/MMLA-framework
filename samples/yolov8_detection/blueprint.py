"""Blueprint for the yolov8_detection demo case."""
...
from implementations.examples.vision.predictors import YoloV8DetectionPredictor

from .collector import prepare_prediction_inputs
from .manifest import CASE_SLUG, YoloV8Manifest
...
def make_blueprint(context: "CaseBuildContext") -> CaseBlueprint:
    ...
    def build_factory(manifest: YoloV8Manifest) -> OrchestratorFactory:
        ...
        async def factory() -> CaseOrchestrator:
            ...
            predictor_service.register(PredictionStage.ANALYTICS, YoloV8DetectionPredictor(manifest.predictors.analytics))
    ...
    return CaseBlueprint(slug=slug_str, manifest_model=YoloV8Manifest, build_factory=build_factory)
